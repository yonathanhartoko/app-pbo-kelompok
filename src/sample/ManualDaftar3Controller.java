 ...
 */
public class ManualDaftar3Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        next.setOnAction(event -> {
            ...
            try {
                AnchorPane page = FXMLLoader.load(getClass().getResource("ManualDaftar4.fxml"));
                Scene scene = new Scene(page);
                stage.setScene(scene);
            } catch (IOException e) {
                e.printStackTrace();
        ...
        prev.setOnAction(event -> {
            ...
            try {
                AnchorPane page = FXMLLoader.load(getClass().getResource("ManualDaftar2.fxml"));
                Scene scene = new Scene(page);
                stage.setScene(scene);
            } catch (IOException e) {
                e.printStackTrace();
